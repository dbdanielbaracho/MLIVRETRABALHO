...
- **Documento da Verdade vigente:** `docs/documento-da-verdade/DOCUMENTO_DA_VERDADE_v1.10.md`, que incorpora as versões anteriores por referência e registra o delta normativo vigente.
