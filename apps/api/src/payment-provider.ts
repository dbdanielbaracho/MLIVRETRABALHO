...
export type VerifiedPaymentEvent={provider:string;tenantId:string;assignmentId:string;eventType:PaymentEventType;amountCents:number;providerReference?:string;recipientProfessionalId?:string;idempotencyKey:string};
