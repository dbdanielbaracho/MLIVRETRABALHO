...
export type VerifiedPaymentEvent={tenantId:string;assignmentId:string;eventType:PaymentEventType;amountCents:number;providerReference?:string;idempotencyKey:string};
